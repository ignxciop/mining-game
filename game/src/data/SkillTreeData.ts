...
export const SKILL_TREE: SkillNodeDef[] = [
  ...
  { id: 'oceanic_crown', name: 'Corona Oceánica', description: 'Desbloquea Aguamarina', icon: '🌊', maxLevel: 1, costs: [{ resource: 'emerald', amount: 3 }, { resource: 'sapphire', amount: 2 }], requires: ['emerald_garden'], position: { col: 7, row: 2 }, branch: 'prestige', upgradesStat: 'mining_range', upgradeValue: 15, unlocksMineral: 'aquamarine' },
  ...
  { id: 'solar_heart', name: 'Corazón Solar', description: 'Desbloquea Piedra Solar', icon: '☀️', maxLevel: 1, costs: [{ resource: 'emerald', amount: 5 }, { resource: 'aquamarine', amount: 5 }], requires: ['sharp_pick'], position: { col: 7, row: 5 }, branch: 'legendary', upgradesStat: 'pickaxe_power', upgradeValue: 5, unlocksMineral: 'sunstone' },
  ...
  // ═══ MULTI-TARGET (mobile balancing, +1 objetivo simultaneo c/u) ═══
  { id: 'multi_target_1', name: 'Multi-Minado I', description: '+1 objetivo simultáneo (móvil)', icon: '🎯', maxLevel: 1, costs: [{ resource: 'copper', amount: 10 }, { resource: 'iron', amount: 5 }], requires: ['sharp_pick'], position: { col: 4, row: 6 }, branch: 'utility', upgradesStat: 'multi_target', upgradeValue: 1 },
  { id: 'multi_target_2', name: 'Multi-Minado II', description: '+1 objetivo simultáneo', icon: '🎯', maxLevel: 1, costs: [{ resource: 'obsidian', amount: 5 }, { resource: 'silver', amount: 8 }], requires: ['multi_target_1'], position: { col: 4, row: 7 }, branch: 'utility', upgradesStat: 'multi_target', upgradeValue: 1 },
  { id: 'multi_target_3', name: 'Multi-Minado III', description: '+1 objetivo simultáneo', icon: '🎯', maxLevel: 1, costs: [{ resource: 'fluorite', amount: 5 }, { resource: 'emerald', amount: 2 }], requires: ['multi_target_2'], position: { col: 3, row: 7 }, branch: 'utility', upgradesStat: 'multi_target', upgradeValue: 1 },
]
